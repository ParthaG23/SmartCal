export default {
  ...
  fields: [
    { name: "distance", label: "Trip Distance", type: "number", placeholder: "500", units: ["km", "miles"], defaultUnit: "km" },
    { name: "mileage", label: "Fuel Efficiency", type: "number", placeholder: "15", units: ["km/L", "L/100km", "mpg"], defaultUnit: "km/L" },
    { name: "fuelPrice", label: "Fuel Price", type: "number", placeholder: "105", units: ["₹/L", "$/L", "$/gallon", "€/L"], defaultUnit: "₹/L" },
  ...
  run: ({ distance, mileage, fuelPrice, passengers = 1, fuelType = "petrol",
    ...
    if (mileageUnit  === "L/100km")   m  = 100 / m;
    if (mileageUnit  === "mpg")       m  = m * 1.60934 / 3.785411;
    if (fuelPriceUnit === "$/gallon") fp = fp / 3.785411;
